...
class AcademiesViewController: UIViewController {
    ...
    var academies = [ ("Android Developer", "Android Lorem ipsum dolor sit amet", UIImage(named: "android")),
                      ("Unity Game Developer", "Unity Lorem ipsum dolor sit amet", UIImage(named: "unity")),
                      ("AR / VR Developer", "AR VR Lorem ipsum dolor sit amet", UIImage(named: "arvr")),
                      ("Cloud Developer", "Cloud Lorem ipsum dolor sit amet", UIImage(named: "cloud")),
